...
class AgentDataSource extends DataTableSource {
  ...
  AgentDataSource({required this.agentController, required this.agents, required this.onEdit});
  ...
  DataRow? getRow(int index,) {
    ...
    return DataRow(cells: [
      ...
      DataCell(Chip(
        ...
        color:
            MaterialStateProperty.all(agent.status ? Colors.red : Colors.green),
      )),
      DataCell(Row(
        children: [
          IconButton(
    ...
    "EV charge",
              ...
              AgentDialogs.addEditAgentDialog(context, imageController: imageController, agentController: agentController, services: services, agent: agent);
             }
